#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""PRO engine pre Curio reels (facts dizajn: subjektovo-presny stock, chipy so sync-om, bez mapy) (overeny na Plitvice demu, schvaleny 2026-07-04).
...
UA = {"User-Agent": "Curio/1.0 (educational channel)"}
...
def render_overlay_seq(sc, idx, work):
    ...
    if role == "hook":
        ...
        chips[0] = {"img": chip_png("@Curio", 58, "accent"), "at": 0.35}
...
# ---------------------------------------------------------------- render scen
GRADE = "eq=contrast=1.08:saturation=1.12:brightness=0.02,vignette=angle=PI/5,noise=alls=4:allf=t"
